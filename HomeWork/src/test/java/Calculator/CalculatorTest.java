...
public class CalculatorTest {
    ...
    @Test
    void calculatingDiscount_CorrectParameters_CorrectResultTest(){
        //Arrange

        double purchaseAmount = 100;
        int discountAmount = 10;
        double amountExpected = 90;

        //Act

        double amountActual = Calculator.calculatingDiscount(purchaseAmount, discountAmount);
    ...
    @Test
    void calculatingDiscount_IncorrectAmount_ThrownExceptionTest(){
        //Arrange
        ...
        assertEquals("Argument purchaseAmount less then zero", ex.getMessage());
    }

    @Test
    void calculatingDiscount_IncorrectDiscountLessThanZero_ThrownExceptionTest(){
        //Arrange
        ...
        assertEquals("Argument discountAmount less then zero or greater than 100", ex.getMessage());
    }

    @Test
    void calculatingDiscount_IncorrectDiscountGreaterThanAHundred_ThrownExceptionTest(){
        //Arrange

        double purchaseAmount = 100;
        int discountAmount = 102;
